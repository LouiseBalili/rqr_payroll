                            ...
                            <div>
                                ...
                                <div class="container mx-auto px-4">
                                    <div class="flex justify items-between">
                                        <p class="font-semibold text-gray-700 text-base ml-14">Net Amount</p>
                                        <p class="font-semibold text-green-600 text-base ml-1.5">₱{{ payroll.netAmount }}</p>
                                    </div>
                                    <div>
                                        <button class="px-6 py-2 text-sm rounded-md bg-blue-500 hover:bg-blue-700 text-white ml-10">Update</button>
