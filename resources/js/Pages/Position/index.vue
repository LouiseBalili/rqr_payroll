                    ...
                    <div class=" pr-6">
                        ...
                        <form @submit.prevent="submit" >
                            <div class="px-4 py-5">
                                ...
                                <div>
                                    <label class="font-semibold text-sm text-gray-600  block" for="position">Daily Rate</label>
                                    <input type="text" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full text-gray-600 "  v-model="form.amount"/>
                            ...
                            <table class="min-w-max w-full table-auto">
                                <thead>
                                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                        ...
                                        <th class="py-3 px-6 text-left">Daily Rate</th>
                                    ...
                                    <tr  class="border-b border-gray-200 hover:bg-gray-100" v-for="pos in positions" :key="pos.id">
                                        ...
                                        <td class="py-3 px-6 text-left whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <p class="font-medium">₱{{ pos.amount }}</p>
                                            </div>
                                        </td>
