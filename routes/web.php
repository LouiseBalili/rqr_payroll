...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/payrolls/view/{payroll}', [PayrollController::class, 'show'])->name('payroll.show');


    Route::get('/cashAdvance', [CashAdvanceController::class, 'index'])->name('cashAdvance.index');
    Route::get('/cashAdvance/create', [CashAdvanceController::class, 'create']);
    Route::post('/cashAdvance',[CashAdvanceController::class, 'store']);
